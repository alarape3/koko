module.exports = function(grunt) { 
    grunt.initConfig({
        ...
        uglify: {
          my_target: {
            files: {
                'assets/bundles/libscripts.bundle.js': ['assets/plugins/jquery/jquery-v3.2.1.min.js','assets/plugins/bootstrap/js/popper.min.js','assets/plugins/bootstrap/js/bootstrap.js'], /* main js*/              
                'assets/bundles/vendorscripts.bundle.js':
                ['assets/plugins/bootstrap-select/js/bootstrap-select.js','assets/plugins/jquery-slimscroll/jquery.slimscroll.js','assets/plugins/node-waves/waves.js','assets/plugins/jquery-sparkline/jquery.sparkline.js','assets/plugins/jquery-countto/jquery.countTo.js'], /* coman js*/
                'assets/bundles/mainscripts.bundle.js':
                ['assets/js/admin.js','assets/js/demo.js'], /*coman js*/
